...
<body>
	...
	<nav>
		<ul>
			<li class= "homeLink mainNav"><a href="newTest.html">HOME</a></li>
			<li class= "homeLink mainNav slash">\</li>
			<li class="aboutLink mainNav"><a class="aboutLink" href="underConst.html">ABOUT</a></li>
			<li class= "homeLink mainNav slash">\</li>
			<li class="workLink mainNav"><a href="underConst.html">WORK</a></li>
			<li class= "homeLink mainNav slash">\</li>
...
<section class="parallax-content">
	...
	<p style="text-align: center; text-shadow: 5px 5px #3b3b3a; font-family: 'Arvo', serif; font-size: 2.5em; color: #f9ecd9;  margin-top: 950px; margin-right: 200px; margin-left: 200px;">Hi! I'm Chris. Mandrake is an educational venture that I am embarking apon to learn web design and developement. Here you can find some of the projects that I've worked on. If you want to give me another project to work on, send me a message! </p>
    </div>
</section>
